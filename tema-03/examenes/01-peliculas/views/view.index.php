    ...
    <div class="container">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <?php foreach ($peliculas as $pelicula): ?>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="modificar.php?indice=<?= $pelicula['id'] ?>" Title="Modificar"><i class="bi bi-pencil-square"></i></a>
                <a href="mostrar.php?indice=<?= $pelicula['id'] ?>" Title="Mostrar"><i class="bi bi-eye"></i></a>
              </td>
          ...
          <tfoot>
                <tr>
                    <td colspan="7">Numero Registros: <?= count($peliculas) ?></td>
                </tr>
            </tfoot>
